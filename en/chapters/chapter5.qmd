...
Now visit `http://localhost:8000/profile/philipe` and `http://localhost:8000/profile/matheus`. Same template, different data, different pages. Visit `http://localhost:8000/profile/nobody` and you get a proper 404 page.
